...
class _ReportScreenState
  ...
  Future<void> exportPDF() async {
    ...
    final path =
        await ExcelHelper.exportPdfByDate(
  ...
  Future<void> exportExcel() async {
    ...
    final path =
        await ExcelHelper.exportExcelByDate(
              ...
              child: const Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    "Generate professional PDF and Excel reports using selected date ranges.",
...
class _ReportScreenState extends State<ReportScreen> {
  ...
  Future<void> exportPDF() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text("${t.translate("pdf_saved")}\n$path"),
        backgroundColor: Colors.green,
      ),
    );
  }
  ...
  Future<void> exportExcel() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text("${t.translate("excel_saved")}\n$path"),
        backgroundColor: Colors.green,
      ),
    );
  }
  ...
  Future<void> uploadPDF() async {
    ...
    if (result == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(t.translate("no_pdf_selected")),
        ),
      );
      return;
    }
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text("${t.translate("pdf_imported")}: ${file.name}"),
          backgroundColor: Colors.green,
        ),
      );
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(t.translate("pdf_failed")),
        ),
      );
    }
  }
